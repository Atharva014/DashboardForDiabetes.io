...
innerfig1 = px.histogram(df, x=['Positive', 'Negetive'], y= [ (len(df[df['Outcome'] == 1])), 
                            (len(df[df['Outcome'] == 0])) ], template = 'simple_white')
innerfig1.update_xaxes(title_text='Results')
innerfig1.update_yaxes(title_text='Records')
    ...
    html.Div([
        ...
        html.Div([ 
            ...
            html.Div([
                ...
                html.P('Distribution of Diabetes Parameters: ', style={'text-align':'center', 'font-size':'20px'}),
